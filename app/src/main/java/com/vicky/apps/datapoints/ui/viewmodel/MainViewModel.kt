...
class MainViewModel(private val repository: Repository,
    ...
    fun checkAndSumTheValue( key:String, listCount: List<Record>){
    ...
    fun checkFirstQuarter(check:String):Boolean = check.split("-")[1] != "Q1"
    ...
    fun generateApiCall():Single<ResponseData>{
     ...
     fun createRequestParams(): Map<String,String>{
